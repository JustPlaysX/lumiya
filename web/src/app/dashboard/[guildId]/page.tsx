      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        <div className="mb-8 flex items-center gap-4">
          {icon ? (
            ...
            <img src={icon} alt="" className="h-14 w-14 rounded-full" />
          ) : (
            <span className="grid h-14 w-14 place-items-center rounded-full bg-lumiya-700 text-xl font-bold text-white">
